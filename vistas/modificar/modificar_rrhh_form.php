...
if (!isset($_SESSION['nombre'])) {                                                              // Sino existe la variable Session
    ...
    if ($_SESSION['tipo'] === "ADMINISTRADOR" || $_SESSION['tipo'] === "SECRETARIA" || $_SESSION['tipo'] === "SECRETARIA GENERAL") {
        ...
        $sentencia = $bd->prepare("SELECT * FROM rrhh WHERE id_rrhh = ?;");
        $sentencia->execute([$id_rrhh_key]);
...
<body>
    ...
    <div class="container-fluid fix">
        <div class="row">
            <h3 style="text-align:center; margin-top: 20px;">Modificar RRHH</h3>
        </div><br>

        <form class="form-horizontal form-bg" method="POST" action="../../procesos/modificar/modificar_rrhh_proceso.php" autocomplete="off">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <select class="form-select" name="dep_subdepto" id="dep_subdepto" require>
                                <option style="background-color: rgb(241, 105, 146);" value="<?php echo $idNew->dep_subdepto; ?>"><?php echo $idNew->dep_subdepto; ?></option>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-select" name="unid_especifica" id="unid_especifica" require>
                                <option style="background-color: rgb(241, 105, 146);" value="<?php echo $idNew->unid_especifica; ?>"><?php echo $idNew->unid_especifica; ?></option>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombres" value="<?php echo $idNew->nombre; ?>" required>
                        </div>

                        <div class="form-group col">
                            <label for="apellido_paterno" class="col-sm-2 control-label">Apellido Paterno</label>
                            <input type="text" class="form-control" id="apellido_paterno" name="apellido_paterno" value="<?php echo $idNew->apellido_paterno; ?>" placeholder="Apellido Paterno" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" value="<?php echo $idNew->apellido_materno; ?>" placeholder="Apellido Materno" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <select class="form-select" name="calidad" id="calidad" require>
                                <option style="background-color: rgb(241, 105, 146);" value="<?php echo $idNew->calidad; ?>"><?php echo $idNew->calidad; ?></option>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-select" name="escalafon" id="escalafon" require>
                                <option style="background-color: rgb(241, 105, 146);" value="<?php echo $idNew->escalafon; ?>"><?php echo $idNew->escalafon; ?></option>
                        ...
                        <div class="form-group col-2">
                            ...
                            <input type="number" min="0" max="100" class="form-control" id="grado" name="grado" value="<?php echo $idNew->grado; ?>" placeholder="Grado" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="estudio_titulo" name="estudio_titulo" value="<?php echo $idNew->estudio_titulo; ?>" placeholder="Estudio o Titulo" required>
                        </div>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-select" name="tipo_contrato" id="tipo_contrato" require>
                                <option style="background-color: rgb(241, 105, 146);" value="<?php echo $idNew->tipo_contrato; ?>"><?php echo $idNew->tipo_contrato; ?></option>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" min="1900" max="2099" step="1" id="ano_ingreso" name="ano_ingreso" value="<?php echo $idNew->ano_ingreso; ?>" placeholder="Año Ingreso" required>
                        </div>

                        <div class="form-group col">
                            <label for="correo" class="col-sm-2 control-label">Correo</label>
                            <input type="email" class="form-control" id="correo" name="correo" value="<?php echo $idNew->correo; ?>" placeholder="Correo" required>
                        </div>

                        <div class="form-group col">
                            <label for="domicilio" class="col-sm-2 control-label">Domicilio</label>
                            <input type="text" class="form-control" id="domicilio" name="domicilio" value="<?php echo $idNew->domicilio; ?>" placeholder="Domicilio" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" maxlength="9" class="form-control" id="fono_contacto" name="fono_contacto" value="<?php echo $idNew->fono_contacto; ?>" placeholder="Fono Contacto" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_nacimiento" class="col-sm-2 control-label">Fecha Nac</label>
                            <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="<?php echo $idNew->fecha_nacimiento; ?>" placeholder="Fecha Nacimiento" required>
                        </div>

                        <div class="form-group col">
                            <label for="edad" class="col-sm-2 control-label">Edad</label>
                            <input type="text" class="form-control" id="edad" name="edad" value="<?php echo $idNew->edad; ?>" readonly>
                        </div>
                    </div><br>

                    <div class="row">
                        <div class="form-group col">
                            <label for="enfermedad_cronica" class="col-sm-2 control-label">Enfermedad Cronica</label>
                            <input type="text" class="form-control" id="enfermedad_cronica" name="enfermedad_cronica" value="<?php echo $idNew->enfermedad_cronica; ?>" placeholder="Enfermedad Cronica" required>
                        </div>

                        <div class="form-group col">
                            <label for="estado_civil" class="col-sm-2 control-label">Estado Civil</label>
                            <select class="form-select" name="estado_civil" id="estado_civil" require>
                                <option style="background-color: rgb(241, 105, 146);" value="<?php echo $idNew->estado_civil; ?>"><?php echo $idNew->estado_civil; ?></option>
