...
if (!isset($_SESSION['nombre'])) {
    ...
    if ($_SESSION['tipo'] === "ADMINISTRADOR" || $_SESSION['tipo'] === "PROYECTOS") {
        ...
        if (empty($idsRecepcion)) {      // VALIDA SI relacion_id ESTA VACIA
            ...
            header('Location: ../../nueva_recepcion.php?result_copy=' . $id_relacion_key . '');  // En vez de enviar "1", se envia id para poder ser usada en la alerta de registro existente (nueva_recepcion.php)
        }
...
<body>
    ...
    <div class="container-fluid fix">
        <div class="row">
            <h3 style="text-align:center; margin-top: 20px;">Ingreso Recepción</h3>
        </div><br>

        <form class="form-horizontal form-bg" method="POST" action="../../procesos/guardar/guardar_recepcion.php" autocomplete="off">
            <!-- Form 1 -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="ano_fabrica" name="ano_fabrica" placeholder="Año Fabricación" min="2000" max="2099" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="producto_solicitado" name="producto_solicitado" placeholder="Producto Solicitado" required>
                        </div>

                        <div class="form-group col">
                            <label for="requerimiento_tecnico" class="col-sm-2 control-label">Requeri Tec</label>
                            <input type="text" class="form-control" id="requerimiento_tecnico" name="requerimiento_tecnico" placeholder="Requerimiento Tecnico" required>
                        </div>
                    </div><br>

                    <div class="row">
                        <div class="form-group col">
                            <label for="nombre_proyecto" class="col-sm-2 control-label">Nombre Proyecto</label>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="decreto" name="decreto" placeholder="Decreto" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_decreto" class="col-sm-2 control-label">Fecha Decreto</label>
                            <input type="date" class="form-control" id="fecha_decreto" name="fecha_decreto" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="resolucion_especi_tec" name="resolucion_especi_tec" placeholder="Resolución Especificaciones Tec" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_resolu_especi_tec" class="col-sm-2 control-label">Fecha R.E.T</label>
                            <input type="date" class="form-control" id="fecha_resolu_especi_tec" name="fecha_resolu_especi_tec" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="resolucion_adjudicacion" name="resolucion_adjudicacion" placeholder="Resolución Adjudicación" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="resolucion_contrato" name="resolucion_contrato" placeholder="Resolución Contrato" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_resolu_contrato" class="col-sm-2 control-label">Fecha R.C</label>
                            <input type="date" class="form-control" id="fecha_resolu_contrato" name="fecha_resolu_contrato" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="orden_compra" name="orden_compra" placeholder="Orden De Compra" required>
                        </div>
                    </div><br>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="date" class="form-control" id="fecha_orden_compra" name="fecha_orden_compra" required>
                        </div>

                        <div class="form-group col">
                            <label for="detalle_orden_compra" class="col-sm-2 control-label">Detalle O.C</label>
                            <input type="text" class="form-control" id="detalle_orden_compra" name="detalle_orden_compra" placeholder="Detalle Orden De Compra" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="plazo_entrega" name="plazo_entrega" placeholder="Plazo Entrega" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" name="rut" id="rut" placeholder="Ejem: 00.000.000-k" maxlength="12" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="numero_acta" name="numero_acta" placeholder="Numero Acta" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="date" class="form-control" id="fecha_recepcion_parcial" name="fecha_recepcion_parcial" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_puesta_marcha" class="col-sm-2 control-label">F. Puesta Marcha</label>
                            <input type="date" class="form-control" id="fecha_puesta_marcha" name="fecha_puesta_marcha" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="date" class="form-control" id="fecha_recepcion_final" name="fecha_recepcion_final" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="garantia_fabricante" name="garantia_fabricante" placeholder="Garantia Fabricante" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="date" class="form-control" id="fecha_inicio_garanti_fabricante" name="fecha_inicio_garanti_fabricante" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_termino_garanti_fabricante" class="col-sm-2 control-label">F. Term Gtia Fabri</label>
                            <input type="date" class="form-control" id="fecha_termino_garanti_fabricante" name="fecha_termino_garanti_fabricante" required>
                        </div>
                    </div><br>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" class="form-control" id="mantenciones_en_garantia" name="mantenciones_en_garantia" placeholder="Mantenciones en Garantia" required>
                        </div>

                        <div class="form-group col">
                            <label for="periodo_mantenci_garanti" class="col-sm-2 control-label">Periodo Mantención Gtia</label>
                            <input type="text" class="form-control" id="periodo_mantenci_garanti" name="periodo_mantenci_garanti" placeholder="Periodo Mantención Garantia" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="verificable_entrega" name="verificable_entrega" placeholder="Verificable Entrega" required>
                        </div>

                        <div class="form-group col">
                            <label for="fecha_verificable" class="col-sm-2 control-label">F. Verificable</label>
                            <input type="date" class="form-control" id="fecha_verificable" name="fecha_verificable" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="ref_tecnico_recepcion" name="ref_tecnico_recepcion" placeholder="Ref Tecnico Recepción" required>
                        </div>

                        <div class="form-group col">
                            <label for="ref_tecnico_clinico" class="col-sm-2 control-label">Ref Tec Clinico</label>
                            <input type="text" class="form-control" id="ref_tecnico_clinico" name="ref_tecnico_clinico" placeholder="Ref Tecnico Clinico" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="ref_tecnico_externo" name="ref_tecnico_externo" placeholder="Ref Tecnico Externo" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="otro_referente_1" name="otro_referente_1" placeholder="Ref" required>
                        </div>

                        <div class="form-group col">
                            <label for="otro_referente_2" class="col-sm-2 control-label">Otro Referente</label>
                            <input type="text" class="form-control" id="otro_referente_2" name="otro_referente_2" placeholder="Ref" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="accesorio_1" name="accesorio_1" placeholder="Accesorio" min="0">
                        </div>

                        <div class="form-group col">
                            <label for="accesorio_2" class="col-sm-2 control-label">Accesorio 2</label>
                            <input type="text" class="form-control" id="accesorio_2" name="accesorio_2" placeholder="Accesorio" min="0">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="accesorio_3" name="accesorio_3" placeholder="Accesorio" min="0">
                        </div>

                        <div class="form-group col">
                            <label for="accesorio_4" class="col-sm-2 control-label">Accesorio 4</label>
                            <input type="text" class="form-control" id="accesorio_4" name="accesorio_4" placeholder="Accesorio" min="0">
                        </div>
                    </div><br>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="accesorio_5" name="accesorio_5" placeholder="Accesorio" min="0">
                        </div>

                        <div class="form-group col">
                            <label for="accesorio_6" class="col-sm-2 control-label">Accesorio 6</label>
                            <input type="text" class="form-control" id="accesorio_6" name="accesorio_6" placeholder="Accesorio" min="0">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="accesorio_7" name="accesorio_7" placeholder="Accesorio" min="0">
                        </div>

                        <div class="form-group col">
                            <label for="accesorio_8" class="col-sm-2 control-label">Accesorio 8</label>
                            <input type="text" class="form-control" id="accesorio_8" name="accesorio_8" placeholder="Accesorio" min="0">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" id="accesorio_9" name="accesorio_9" placeholder="Accesorio" min="0">
                        </div>

                        <div class="form-group col">
                            <label for="accesorio_10" class="col-sm-2 control-label">Accesorio 10</label>
                            <input type="text" class="form-control" id="accesorio_10" name="accesorio_10" placeholder="Accesorio" min="0">
                        </div>
                    </div><br>
