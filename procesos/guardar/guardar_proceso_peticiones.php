...
if (!isset($_SESSION['nombre'])) {
    ...
    if ($_SESSION['tipo'] === "ADMINISTRADOR" || $_SESSION['tipo'] === "SECRETARIA" || $_SESSION['tipo'] === "SECRETARIA GENERAL") {
        ...
        $sentencia = $bd->prepare("INSERT INTO proceso_peticiones (exigencia, acreditacion, categoria, covid, sub_depto, unidad, ref_tec_1, cargo_ref_tec_1, ref_tec_2, cargo_ref_tec_2, 
        serv_usuario, sector, tipo_peticion, descr_solicitud, obser_pet, orden_trabajo, tipo_compra, doc_adjunta, id_contrato_conexo, plazo_entrega, sisq, mp, mc, eq_2_1, eq_2_2, ins_3_1, 
        ins_3_2, plan_expansion, mal_uso, garantia, 
        ...
        neto_gral, iva_gral, total_gral, rut, empresa, item_ppto_solicitado) VALUES (
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
                                    ?, ?, ?, ?, 
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
        ...
        $_SESSION['tipo'] === "TECNICOS" || $_SESSION['tipo'] === "MANTENCION"
    ) {
        header('Location: ../../home_proceso_peticiones.php');
    }
} else {
