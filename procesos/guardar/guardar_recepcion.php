...
if (!isset($_SESSION['nombre'])) {                                                              // Sino existe la variable Session
    ...
    if ($_SESSION['tipo'] === "ADMINISTRADOR" || $_SESSION['tipo'] === "PROYECTOS") {
        ...
        $sentencia = $bd->prepare("INSERT INTO recepcion (ano_fabrica, financiamiento, producto_solicitado,
                                    ...
                                    tipo_de_dias, fecha_entrega, rut, proveedor, numero_acta, fecha_recepcion_parcial,
                                    ...
                                    otro_referente_1, otro_referente_2, accesorio_1, accesorio_2, accesorio_3, accesorio_4, accesorio_5, accesorio_6, accesorio_7, 
                                    accesorio_8, accesorio_9, accesorio_10, observaciones, cantidad, 
                                    relacion_id) VALUES (
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
