...
if (!isset($_SESSION['nombre'])) {
    ...
    if ($_SESSION['tipo'] === "ADMINISTRADOR" || $_SESSION['tipo'] === "MANTENCION" || $_SESSION['tipo'] === "TECNICOS") {
        ...
        $sentencia = $bd->prepare("INSERT INTO mantenciones (responsable, correo_responsable, ubicacion, acreditacion, estado, id_licitacion_convenio, 
            ...
            programado_11, fecha_mp_11, programado_12, fecha_mp_12, id_mantenciones_relacion) VALUES (
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 
                                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        if ($adjunto_1 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 1')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 1')) {
                    if (move_uploaded_file($guardardo_1, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 1' . '/' . $adjunto_1)) {
        ...
        if ($adjunto_2 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 2')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 2')) {
                    if (move_uploaded_file($guardardo_2, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 2' . '/' . $adjunto_2)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_3 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 3')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 3')) {
                    if (move_uploaded_file($guardardo_3, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 3' . '/' . $adjunto_3)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_4 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 4')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 4')) {
                    if (move_uploaded_file($guardardo_4, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 4' . '/' . $adjunto_4)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_5 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 5')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 5')) {
                    if (move_uploaded_file($guardardo_5, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 5' . '/' . $adjunto_5)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_6 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 6')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 6')) {
                    if (move_uploaded_file($guardardo_6, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 6' . '/' . $adjunto_6)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_7 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 7')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 7')) {
                    if (move_uploaded_file($guardardo_7, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 7' . '/' . $adjunto_7)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_8 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 8')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 8')) {
                    if (move_uploaded_file($guardardo_8, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 8' . '/' . $adjunto_8)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_9 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 9')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 9')) {
                    if (move_uploaded_file($guardardo_9, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 9' . '/' . $adjunto_9)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_10 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 10')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 10')) {
                    if (move_uploaded_file($guardardo_10, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 10' . '/' . $adjunto_10)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_11 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 11')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 11')) {
                    if (move_uploaded_file($guardardo_11, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 11' . '/' . $adjunto_11)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
        ...
        if ($adjunto_12 != null) {
            if (!file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 12')) {
                ...
                if (file_exists('../../mantenciones/' . $_POST['envioID'] . '/Adjunto 12')) {
                    if (move_uploaded_file($guardardo_12, '../../mantenciones/' . $_POST['envioID'] . '/Adjunto 12' . '/' . $adjunto_12)) {
                        echo 'Archivo guardado';
                    } else {
                        echo 'error';
                    }
